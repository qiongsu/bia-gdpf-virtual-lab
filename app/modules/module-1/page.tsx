    ...
    <AppShell>
      <div className="page-wrap">
        ...
        <section className="xylem-intro-grid" aria-labelledby="xylem-overview-title">
          ...
          <figure className="xylem-feature"><img src="/assets/xylem/wood-anatomy.png" alt="Tree section labeled bark, sapwood, and heartwood" /><figcaption>Begin at the whole-tree scale: locate the bark, sapwood, and heartwood before zooming into xylem anatomy.</figcaption></figure>
        </section>
